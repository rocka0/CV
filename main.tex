...
\begin{center}
  ...
  $|$
  \faCode \hspace{.5pt} \href{https://codeforces.com/profile/m0nstercat}{Codeforces}
\end{center}
...
\begin{tabular*}{0.97\textwidth}[t]{l@{\extracolsep{\fill}}r}
  ...
  \textit{\small B.E. in Computer Science and Engineering; \textbf{CGPA: 9.67/10.00}} & \textit{\small Nov 2020 \textbf{--} July 2024} \\
\end{tabular*}\vspace{-5pt}
\resumeItemListStart
\resumeItem{\textbf{Major coursework:} Operating Systems, Data Structures and Algorithms, Computer Networks, Compiler Construction, Software Engineering, Database Systems, Object-Oriented Programming}
\resumeItem{\textbf{Additional coursework:} Design and Analysis of Algorithms, Computational Geometry, Theory of Computation, Computer Architecture, Discrete Structures for Computer Science, Professional Ethics}
\resumeItemListEnd

\vspace{-2pt}\item
\begin{tabular*}{0.97\textwidth}[t]{l@{\extracolsep{\fill}}r}
  \textbf{National Public School} & Bangalore, India \\
  \textit{\small CBSE Class XII; \textbf{CGPA: 9.64/10}} & \textit{\small July 2020} \\
  \textit{\small CBSE Class X; \textbf{CGPA: 9.56/10}} & \textit{\small July 2018} \\
\end{tabular*}\vspace{-7pt}
...
\resumeSubHeadingListStart
\small{\item{
              \textbf{Languages:}{ C, C++, Python, JavaScript, HTML/CSS, SQL, Java} \\ \vspace{3pt}
...
\resumeItemListStart
\resumeItem{Google developed an SSD-based cache on top of the MySQL InnoDB storage engine’s buffer pool for improved database query performance.}
\resumeItem{Designed a verification utility to ensure data integrity and metadata consistency of this auxiliary cache.}
\resumeItem{The utility was written in C++. Automated unit/end-to-end tests were written with MTR (MySQL Test Run).}
\resumeItem{Gained a deep understanding of the InnoDB storage engine, buffer pool and the MySQL server architecture.}
\resumeItemListEnd
